    ...
    public class TextProOnACircle : TextProOnACurve
    {
        ...
        protected override bool ParametersHaveChanged()
        {
            ...
            bool retVal = m_radius != m_oldRadius || m_arcDegrees != m_oldArcDegrees || 
                          m_angularOffset != m_oldAngularOffset || m_oldMaxDegreesPerLetter != m_maxDegreesPerLetter;
            ...
            TMP_TextInfo textInfo, int charIdx)      
        {
            ...
            float actualArcDegrees = Mathf.Min(m_arcDegrees,
                textInfo.characterCount / textInfo.lineCount * m_maxDegreesPerLetter);
            ...
            float angle = ((zeroToOnePos - 0.5f) * actualArcDegrees + m_angularOffset) 
            ...
            float radiusForThisLine = m_radius - textInfo.lineInfo[0].lineExtents.max.y 
